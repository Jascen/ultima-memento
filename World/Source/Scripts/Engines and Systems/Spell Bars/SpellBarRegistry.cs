...
namespace Server.SpellBars
{
	public static partial class SpellBarRegistry
	{
		...
		private static SpellBarDefinition[] BuildDefinitions()
		{
			return new[]
			{
				Bar(SpellBarId.Ancient_1, SpellBarSchool.Ancient, AncientSpellSchool.Instance, 1, "archtool1", "archclose1", "archspell1", "SPELL BAR - ANCIENT", true),
				Bar(SpellBarId.Ancient_2, SpellBarSchool.Ancient, AncientSpellSchool.Instance, 2, "archtool2", "archclose2", "archspell2", "SPELL BAR - ANCIENT", true),
				Bar(SpellBarId.Ancient_3, SpellBarSchool.Ancient, AncientSpellSchool.Instance, 3, "archtool3", "archclose3", "archspell3", "SPELL BAR - ANCIENT", true),
				Bar(SpellBarId.Ancient_4, SpellBarSchool.Ancient, AncientSpellSchool.Instance, 4, "archtool4", "archclose4", "archspell4", "SPELL BAR - ANCIENT", true),
				Bar(SpellBarId.Bard_1, SpellBarSchool.Bard, BardSpellSchool.Instance, 1, "bardtool1", "bardclose1", "bardsong1", "SPELL BAR - BARD", false),
				Bar(SpellBarId.Bard_2, SpellBarSchool.Bard, BardSpellSchool.Instance, 2, "bardtool2", "bardclose2", "bardsong2", "SPELL BAR - BARD", false),
				Bar(SpellBarId.Death_1, SpellBarSchool.DeathKnight, DeathKnightSpellSchool.Instance, 1, "deathtool1", "deathclose1", "deathspell1", "SPELL BAR - DEATH KNIGHT", false),
				Bar(SpellBarId.Death_2, SpellBarSchool.DeathKnight, DeathKnightSpellSchool.Instance, 2, "deathtool2", "deathclose2", "deathspell2", "SPELL BAR - DEATH KNIGHT", false),
				Bar(SpellBarId.Elemental_1, SpellBarSchool.Elemental, ElementalSpellSchool.Instance, 1, "elementtool1", "elementclose1", "elementspell1", "SPELL BAR - ELEMENTALIST", false),
				Bar(SpellBarId.Elemental_2, SpellBarSchool.Elemental, ElementalSpellSchool.Instance, 2, "elementtool2", "elementclose2", "elementspell2", "SPELL BAR - ELEMENTALIST", false),
				Bar(SpellBarId.Knight_1, SpellBarSchool.Knight, KnightSpellSchool.Instance, 1, "knighttool1", "knightclose1", "knightspell1", "SPELL BAR - KNIGHT", false),
				Bar(SpellBarId.Knight_2, SpellBarSchool.Knight, KnightSpellSchool.Instance, 2, "knighttool2", "knightclose2", "knightspell2", "SPELL BAR - KNIGHT", false),
				Bar(SpellBarId.Mage_1, SpellBarSchool.Magery, MagerySpellSchool.Instance, 1, "magetool1", "mageclose1", "magespell1", "SPELL BAR - MAGERY", true),
				Bar(SpellBarId.Mage_2, SpellBarSchool.Magery, MagerySpellSchool.Instance, 2, "magetool2", "mageclose2", "magespell2", "SPELL BAR - MAGERY", true),
				Bar(SpellBarId.Mage_3, SpellBarSchool.Magery, MagerySpellSchool.Instance, 3, "magetool3", "mageclose3", "magespell3", "SPELL BAR - MAGERY", true),
				Bar(SpellBarId.Mage_4, SpellBarSchool.Magery, MagerySpellSchool.Instance, 4, "magetool4", "mageclose4", "magespell4", "SPELL BAR - MAGERY", true),
				Bar(SpellBarId.Monk_1, SpellBarSchool.Monk, MonkSpellSchool.Instance, 1, "monktool1", "monkclose1", "monkspell1", "SPELL BAR - MONK", false),
				Bar(SpellBarId.Monk_2, SpellBarSchool.Monk, MonkSpellSchool.Instance, 2, "monktool2", "monkclose2", "monkspell2", "SPELL BAR - MONK", false),
				Bar(SpellBarId.Necro_1, SpellBarSchool.Necromancy, NecromancySpellSchool.Instance, 1, "necrotool1", "necroclose1", "necrospell1", "SPELL BAR - NECROMANCER", false),
				Bar(SpellBarId.Necro_2, SpellBarSchool.Necromancy, NecromancySpellSchool.Instance, 2, "necrotool2", "necroclose2", "necrospell2", "SPELL BAR - NECROMANCER", false),
				Bar(SpellBarId.Priest_1, SpellBarSchool.Priest, PriestSpellSchool.Instance, 1, "holytool1", "holyclose1", "holyspell1", "SPELL BAR - PRIEST", false),
				Bar(SpellBarId.Priest_2, SpellBarSchool.Priest, PriestSpellSchool.Instance, 2, "holytool2", "holyclose2", "holyspell2", "SPELL BAR - PRIEST", false),
			};
		}
	}
}